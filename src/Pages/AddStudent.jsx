        ...
        <>
            <div className='edit'>
                <div className='header'>
                    <input type="text" name="Name" className='input' placeholder='Write ur Name' value={Name} onChange={(e) => setName(e.target.value)} />
                    <input type="text" name="number" className='input' placeholder='Write ur Age' value={Age} onChange={(e) => setAge(e.target.value)} />
